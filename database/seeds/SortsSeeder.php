...
class SortsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Sort::create([
            'title' => 'Дашуня',
            'selection' => 'селекции Вишневецкого Н.П., Талисман + Ризамат + Кишмиш лучистый',
        ...
        Sort::create([
            'title' => 'Злато',
            'selection' => 'селекции Капелюшного В.У., Талисман + Кишмиш Новочеркасский',
        ...
        Sort::create([
            'title' => 'Кишмиш Лучистый',
            'selection' => 'Кардинал + Кишмиш Розовый',
        ...
        Sort::create([
            'title' => 'Лучезарный',
            'selection' => 'Кеша1 + Кишмиш Лучистый',
        ...
        Sort::create([
            'title' => 'Преображение',
            'selection' => 'селекции Крайнова В.Н., Талисман + Кишмиш Лучистый',
